...
@RestController
@RequestMapping("/job-perforation")
public class JobPerforationController {
    ...
    public PageRes<JobResDTO> index(PageReq query) {
        ...
        return this.service.findAll(query, TypeJob.PERFORATION);
    }
