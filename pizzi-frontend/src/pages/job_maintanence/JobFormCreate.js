...
const GetStepContent = ({
    ...
    switch (step) {
        ...
        case 1:
            return (
                <Step2 handleChangeStep2={handleChangeStep2} jobMaintenance={jobMaintenance}/>
            );
        
        case 2:
            return (
                <Step3 handleChangeStep3={handleChangeStep3} jobMaintenance={jobMaintenance}/>
            );
        case 3:
            return (
                <Step4 handleChangeStep4={handleChangeStep4} jobMaintenance={jobMaintenance}/>
            );
        case 4:
            return (
                <Step5 handleChangeStep5={handleChangeStep5} jobMaintenance={jobMaintenance}/>
            );
        default:
            return 'Unknown step';
    }
...
export const JobMaintenanceFormCreate = props => {
    ...
    const [jobMaintenance, setJobMaintenance] = useState();
    ...
    const saveClient = async  () => {
        ...
        await axios.post(`${URL.baseURL}/job-maintenance/client/${clientCurrent.id}`).then(res => {
            
            setJobMaintenance(res.data);
    ...
    const saveGeneral = async  () => {
        ...
        await axios.put(`${URL.baseURL}/job-maintenance/${jobMaintenance.id}/general`, jobMaintenance).then(res => {
    ...
    const saveProductsUsed = async  () => {
        ...
        await axios.put(`${URL.baseURL}/job-maintenance/${jobMaintenance.id}/products-used`, productsUsed).then(res => {
    ...
    const saveAssistanceUsed = async  () => {
        ...
        await axios.put(`${URL.baseURL}/job-maintenance/${jobMaintenance.id}/assistance`, idsAssistances).then(res => {
    ...
    const saveTotal = async  () => {
            ...
            await axios.put(`${URL.baseURL}/job-maintenance/${jobMaintenance.id}/total`, jobMaintenance).then(res => {
    ...
    const handleNext = () => {
        ...
        switch (activeStep) {
            case 0:
                ...
                break;
            case 1:
                jobMaintenance.dateJob != undefined ? saveGeneral() : notify('Data de perfuração não pode estar em branco, verefique e tente novamente', 'warning')
                break;
            case 2:
                saveProductsUsed();
                break;
    ...
    const handleChangeStep2 = (event) => {
        ...
        setJobMaintenance({...jobMaintenance, [event.target.name] : event.target.value})
...
export default JobMaintenanceFormCreate;